...
<%@page import="com.abcdef.frm.service.info.SuggestBoxService"%>
<%@page import="com.abcdef.core.util.AppUtil"%>
<%@page import="com.abcdef.frm.model.info.SuggestBox"%>
			...
			<c:if test="${not empty suggestBox.replyContent}">
				<tr >
					...
					<tr >
						...
						<td width="90%" style="padding-left:10px;border: 1px #c7e3fa solid;">
							<font color="green">
								<fmt:formatDate value="${suggestBox.replyTime}" pattern="yyyy-MM-dd HH:mm:ss" />
							</font>
						</td>
					</tr>
					<tr >
