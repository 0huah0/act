...
<script type="text/javascript" src="<%=basePath%>/js/frm/dynamic.jsp"></script>
...
<script type="text/javascript" src="<%=basePath%>/ext3/ext-lang-zh_TW.js"></script>
...
<script type="text/javascript" src="<%=basePath%>/js/frm/App.import.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/frm/selector/OnlineUserSelector.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/frm/sound/soundmanager2.js"></script>
...
<script type="text/javascript" src="<%=basePath%>/js/frm/IndexPage.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/frm/App.home.js"></script>
<script type="text/javascript" src="<%=basePath%>/js/frm/App.js"></script>
<script type="text/javascript">
	Ext.onReady(function(){
...
<body>
	...
	<div id="app-header" style="display: none">
		<div id="header-left">
			<img id="CompanyLogo" src="<%=basePath%>/images/SH_Logo.png"
		...
		<div id="header-right">
			...
			<div id="searchFormDisplay"
				...
				<div style="float: right; padding-right: 10px;">
					<div id="welcomeMsg">歡迎您，
						<security:authentication property="principal.fullname" />
						，[<a href="#" onclick="IndexPage.resetPassword()">修改密碼</a>]&nbsp;[<a
							href="<%=basePath%>/j_logout.do">登出</a>]
					</div>
				</div>
			</div>
		</div>
