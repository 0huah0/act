...
public class PssSoAttachment extends BaseModel implements GenericModel {
	...
	private java.lang.String soAttachId;
	...
	public void setSoAttachId(java.lang.String value) {
		this.soAttachId = value;
	}
	
	public java.lang.String getSoAttachId() {
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("SoAttachId",getSoAttachId())
	...
	public int hashCode() {
		return new HashCodeBuilder()
			.append(getSoAttachId())
			.toHashCode();
	}
	
	public boolean equals(Object obj) {
		if(obj instanceof PssSoAttachment == false) return false;
		if(this == obj) return true;
		PssSoAttachment other = (PssSoAttachment)obj;
		return new EqualsBuilder()
			.append(getSoAttachId(),other.getSoAttachId())
			.isEquals();
	}
