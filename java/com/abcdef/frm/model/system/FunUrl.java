...
public class FunUrl extends BaseModel implements GenericModel {
	...
	public com.abcdef.frm.model.system.AppFunction getAppFunction () {
		return appFunction;
	}	
	
	public void setAppFunction (com.abcdef.frm.model.system.AppFunction in_appFunction) {
	...
	public void setFunctionId(Long aValue) {
	    if (aValue==null) {
	        ...
	        appFunction = new com.abcdef.frm.model.system.AppFunction(aValue);
