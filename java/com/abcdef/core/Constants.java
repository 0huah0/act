...
public class Constants {
	 ...
	 * 公司LOGO路径
	 */
	public static final String LOGO_PATH="app.logoPath";
	/**
	 * 默认的LOGO
	 */
	public static final String DEFAULT_LOGO="/images/gds-logo.png";
	 ...
	 * 应用名称
	 */
	public static final String APPLICATION_NAME="app.ApplicationName";
	/**
	 * 默认应用的名称
	 */
	public static final String DEFAULT_APPLICATIONNAME="企业应用框架";
	/**
	 * 通过审核
	 */
